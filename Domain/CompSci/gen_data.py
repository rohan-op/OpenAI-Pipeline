...
transformed_fname = "Transform/Domain/CompSci/transform_semantic_CompSci.csv"
generative_fname = "Generative/Domain/generative_CompSci_100.csv"
...
for i in range(0, len(df), chunk_size):
    ...
    gpt_df = pd.concat([gpt_df,gpt_df_generator(chunk,os.environ.get('OPEN_KEY3'))], ignore_index=True)
