...
transformed_fname = "Transform/Domain/Chemistry/transform_semantic_Chemistry.csv"
generative_fname = "Generative/Domain/generative_Chemistry_100.csv"
...
for i in range(0, len(df), chunk_size):
    ...
    gpt_df = pd.concat([gpt_df,gpt_df_generator(chunk,os.environ.get('OPEN_KEY2'))], ignore_index=True)
